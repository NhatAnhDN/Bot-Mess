...
async function onCall({ message, args }) {
    ...
    if (!args[0] || !args[1]) return global.api.sendMessage(`Vui lòng dùng ${global.config.PREFIX}bmi + chiều cao + cân nặng để tính chỉ số BMI của bạn!\nVí dụ: ${global.config.PREFIX}bmi 1.70 50`, threadID, messageID);
